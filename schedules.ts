...
const schedules: Schedule[] = [
    {
        ...
        text: stripIndent`
        五月祭にて，プログラミング生放送企画【TSG LIVE! 6】を開催します!

        テーマは「東西対決」です! LIVE 全体を通して，関東チームと関西チームに分かれて対決します!

        公式サイト: https://live.tsg.ne.jp
        5/15(土): https://youtu.be/NXchTFJh2Js
        5/16(日): https://youtu.be/oitn3AiP6bM
    ...
    },
    {
        ...
        プレイヤー: @661nos, @T0_0WATSON, @NOCO_1002, @syobon_hinata
    ...
    },
    {
        date: '2021-05-15 13:20',
        text: stripIndent`
        プレイヤー: @661nos, @T0-0WATSON, @NOCO_1002, @syobon_hinata
        公式サイト: https://live.tsg.ne.jp
        配信URL: https://youtu.be/NXchTFJh2Js
        `,
        replyToPrevious: true,
    ...
    },
    {
        ...
        text: stripIndent`
        五月祭プログラミング生放送【TSG LIVE! 6】の全プログラムが無事終了いたしました! ご視聴いただき本当にありがとうございました!
